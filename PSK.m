...
for M = [2, 4, 8]
    ...
    switch M %store symbols for use in scatter plot
        case 2
            symbol_frame_2 = symbol_frame;
            bit_frame_2 = bit_frame;
        case 4
            symbol_frame_4 = symbol_frame;
            bit_frame_4 = bit_frame;
        case 8
            symbol_frame_8 = symbol_frame;
            bit_frame_8 = bit_frame;
    end
...
hold on
title('Signal with AWGN-time domain')
...
for M = [2 4 8]
    ...
    switch M 
        case 2
            symbol_frame = symbol_frame_2;
            bit_frame = bit_frame_2;
        case 4
            symbol_frame = symbol_frame_4;
            bit_frame = bit_frame_4;
        case 8
            symbol_frame = symbol_frame_8;
            bit_frame = bit_frame_8;
    end
    ...
    if M == 8
        formatSpec = '%4.0f bit errors out of 1023 bits sent\n';
    end
